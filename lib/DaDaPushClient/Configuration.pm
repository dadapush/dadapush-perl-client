...
#
package DaDaPushClient::Configuration;
...
=head1 Name
        ...
        DaDaPushClient::Configuration - holds the configuration for all DaDaPushClient Modules
...
default: https://www.dadapush.com
...
sub new {
    ...
    # base_url
    $p{base_url} //= 'https://www.dadapush.com';
