...
#
package DaDaPushClient::ApiClient;
...
sub new {
    ...
    my $config;
    if ( $_[0] && ref $_[0] && ref $_[0] eq 'DaDaPushClient::Configuration' ) {
        $config = $_[0];
    } else {
        $config = DaDaPushClient::Configuration->new(@_);
    }
...
sub deserialize
{
    ...
    if (not defined $data) {
        ...
        my $_instance = use_module("DaDaPushClient::Object::$class")->new;
        if (ref $data eq "HASH") {
