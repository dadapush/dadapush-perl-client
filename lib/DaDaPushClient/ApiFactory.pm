...
#
package DaDaPushClient::ApiFactory;
...
usesub DaDaPushClient::Object;

use DaDaPushClient::ApiClient;

=head1 Name

    DaDaPushClient::ApiFactory - constructs APIs to retrieve DaDaPushClient objects

=head1 Synopsis

    package My::Petstore::App;
    
    use DaDaPushClient::ApiFactory;
    
    my $api_factory = DaDaPushClient::ApiFactory->new( ... ); # any args for ApiClient constructor

    # later...
    my $pet_api = $api_factory->get_api('Pet');  
    
    # $pet_api isa DaDaPushClient::PetApi
...
my %_apis = map { $_ =~ /^DaDaPushClient::(.*)$/; $1 => $_ } 
            grep {$_ =~ /Api$/} 
            usesub 'DaDaPushClient';

=head1 new($api_client)
    
    create a new DaDaPushClient::ApiFactory instance with the given DaDaPushClient::ApiClient instance.

=head1 new(%parameters)

    Any parameters are optional, and are passed to and stored on the api_client object.
    
    See L<DaDaPushClient::ApiClient> and L<DaDaPushClient::Configuration> for valid parameters
