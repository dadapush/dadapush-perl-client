...
has _cfg => ( is => 'ro',
              isa => 'DaDaPushClient::Configuration',
              default => sub { DaDaPushClient::Configuration->new() },
              );

has version_info => ( is => 'ro',
                      isa => 'HashRef',
                      default => sub { {
                          app_name => 'DaDaPush Public API',
                          app_version => 'v1',
...
sub _build_af {
    ...
    return DaDaPushClient::ApiFactory->new(%args);
}
...
=head2 DaDaPush Public API version: v1
